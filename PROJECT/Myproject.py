...
class project:
    ...
    def REG_WINDOW(self):
        ...
        self.Button1 =Button(top,text="Register",bg="#E1F5A9",font=('systemfixed', 18),command=self.STOREDATA)
    ...
    def STOREDATA(self):
        ...
        if (i3 not in string.whitespace) and (i4 not in string.whitespace) and self.CHECK1(i4) and len(i4)>=8 :
            ...
            if ((" "+i3+"-") not in file1.read()) and i3!="5g8":
                ...
                if(i4==i5):
                    ...
                    messagebox.showerror("WARNING","PASSWORD DIDN'T MATCH OR INVALID PASSWORD FORMAT")
            else:
                messagebox.showwarning("NOTICE","User Name Already Exists")
            file1.close()
        else:
            messagebox.showinfo("NOTICE","Enter Valid User Name or password")
        return
    ...
    def LOGIN_WINDOW(self):
        ...
        self.entry1=Entry(master,font=("Calibri 15"))
        self.entry1.place(relx=0.4, rely=0.244,height=36, relwidth=0.34)
        self.entry2=Entry(master,show="*",font=("Calibri 15"))
        self.entry2.place(relx=0.4, rely=0.378,height=36, relwidth=0.34)
        self.button1=Button(master,text="Login",bg="#E1F5A9",font=('systemfixed', 18),command=self.VOTING_WINDOW)
        ...
        self.button2=Button(master,text="HELP",bg="#E1F5A9",command=self.HELP_FUN)
    ...
    def VOTING_WINDOW(self):
        ...
        i2=self.entry2.get()
        if (i1!=self.admin):
            if self.CHECK1(i1,i2):
                if self.CHECK2(i1,i2)==0:
                    ...
                    lab1=Label(top, text='PARTY1',bg="yellow",fg="green",font=18,width=50,height=5)
                    lab1.place(relx=0.255, rely=0.209, height=43, width=300)
                    button1=Button(top, text='vote',bg="#E1F5A9",font=18,width=7,height=4, command=self.click1)
                    button1.place(relx=0.573, rely=0.209, height=43, width=76)
                    lab2=Label(top,text="PARTY2",bg="blue",font=18,fg="white",width=50,height=5)
                    lab2.place(relx=0.255, rely=0.333, height=43, width=300)
                    button2=Button(top,text="vote",bg="#E1F5A9",font=18,width=7,height=2,command=self.click2)
                    button2.place(relx=0.573, rely=0.333, height=43, width=76)
                    lab3=Label(top,text="PARTY3",bg="red",font=18,fg="white",width=50,height=5)
                    lab3.place(relx=0.255, rely=0.467, height=43, width=300)
                    button3=Button(top,text="vote",bg="#E1F5A9",font=18,width=7,height=4,command=self.click3)
                    button3.place(relx=0.573, rely=0.467, height=43, width=76)
                    lab4=Label(top,text="Independent",bg="green",font=18,fg="white",width=50,height=5)
                    lab4.place(relx=0.255, rely=0.6, height=43, width=300)
                    button4=Button(top,text="vote",bg="#E1F5A9",font=18,width=7,height=4,command=self.click4)
        ...
        if (i2=="5g8") and (i1==self.admin):
            ...
            button5=Button(top,text="RESULT",bg="#E1F5A9",width=6,height=2,command=self.RESULT)
    ...
    def RESULT(self):
        ...
        if s!=0:
            if m==a and not(a==b or a==c or a==d):
                ...
                s1=str(s)
                messagebox.showinfo("RESULT","PARTY1 wins with "+percent +"% \n in "+s1+" votes")
                f = open('data2.txt','r+')
                f.truncate(0)
                return
